package com.example.springbootrestfuljpa.controller;

import com.example.springbootrestfuljpa.model.UserEntity;
import com.example.springbootrestfuljpa.service.UserService;
import com.example.springbootrestfuljpa.util.CustomErrorType;
...
public class RestApiController {
    ...
    public ResponseEntity<?> deleteUser(@PathVariable int id){
        ...
        if(user == null){
            ...
            return new ResponseEntity(new CustomErrorType("Unable to delete. User with id " + "not found"),HttpStatus.NOT_FOUND);
        }
