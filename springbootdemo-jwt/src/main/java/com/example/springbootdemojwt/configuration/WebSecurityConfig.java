package com.example.springbootdemojwt.configuration;

import com.example.springbootdemojwt.filter.JWTAuthenticationFilter;
import com.example.springbootdemojwt.filter.JWTLoginFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        InMemoryUserDetailsManagerConfigurer<AuthenticationManagerBuilder> mnConfig = auth.inMemoryAuthentication();
        ...
        mnConfig.withUser(u1);
        mnConfig.withUser(u2);
