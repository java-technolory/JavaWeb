package com.example.springbootlogingoogle.common;
...
//    }
    ...
    public UserDetails buildUser(GooglePojo googlePojo) {
        ...
        UserDetails userDetails = new User(googlePojo.getEmail(), "", enable, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities);
        return userDetails;
    }
}
